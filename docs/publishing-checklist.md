...
2. `docs/trail-docs-quick-start.md` includes current workflows.
...
1. `fetch` policy behavior validated with a `trail-docs.policy.json` sample.
...
```bash
npm install -g trail-docs@<x.y.z>
trail-docs --help
```
